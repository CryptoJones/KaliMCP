...
async def run(
    ...
    *,
    ...
    async with _get_semaphore():
        ...
        # Drain stdout/stderr incrementally into capped buffers. Reading as
        # the tool runs (rather than a single communicate() at the end) means
        # a timeout still yields the partial output captured so far instead of
